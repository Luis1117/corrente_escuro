...
# print(m_T)
arr=np.char.replace(np.array(m_T), 'K_hit.txt', '' )
...
# plt.title('Amostra 1394 Mesa#04-Terra#07')
...
# plt.title('Amostra 1394 Mesa#04-Terra07')
...
np.savetxt('Ea1394Mesa#4_Terra07.txt', Ea1394, delimiter=',')
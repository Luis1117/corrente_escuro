...
# plt.title('Amostra 1394_Mesa#02_Terra#07')
# plt.savefig('LnRAvsTMesa04_Terra07.jpg', dpi=300) 
# plt.show()


axisX=Ea_V[0, :][10:22, 10]
axisY=Ea_V[0, :][10:22, 8]
...
for i in range(11):
    ...
    lr_Ln=np.polyfit(Ea_V[i, :][11:22, 10], Ea_V[i, :][11:22, 8], 1, cov=True)
...
# plt.title('Amostra 1394 Mesa#02 Terra#07')
# plt.scatter(x_EA, y_EA, yerr=Err_Y, fmt='o' )
# plt.grid(axis='both')
# plt.xlabel('Tensão (V)')
# plt.ylabel('Ea (meV)')
# plt.errorbar(x_EA, y_EA, yerr=Err_Y, fmt='o', color='r')
# plt.savefig('Ea_Mesa#02_Terra#07.jpg', dpi=300) 
# plt.show()

np.savetxt('Ea_Mesa#02_Terra#07.txt', Ea1394, delimiter=',')
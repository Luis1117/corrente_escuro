...
def my_plot_IvsV():
    dadosiniciais = sorted(glob.glob('./*.txt'))
...
def my_plot_EavsV():
    ...
    for i in range(101):
        ...
        lr_Ln = np.polyfit(Ea_V[i, :][10:19, 10],
                           Ea_V[i, :][10:19, 8], 1, cov=True)
    ...
    plt.title('Amostra 1394 Mesa#02-Terra07 (paso voltagem = 0.1V)')
    ...
    np.savetxt('Ea1394Mesa#2_Terra07MelhorRes.txt', Ea1394, delimiter=',')
    return plt.show()

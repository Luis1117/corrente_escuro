...
def my_plot_EavsV():
    ...
    for i in range(101):
        ...
        lr_Ln = np.polyfit(Ea_V[i, :][12:21, 10],
                           Ea_V[i, :][12:21, 8], 1, cov=True)
    ...
    plt.title('Amostra 1394 Mesa#03-Terra07 (paso voltagem = 0.1V)')
    ...
    np.savetxt('Ea1394Mesa#3_Terra07MelhorRes.txt', Ea1394, delimiter=',')
    return plt.show()

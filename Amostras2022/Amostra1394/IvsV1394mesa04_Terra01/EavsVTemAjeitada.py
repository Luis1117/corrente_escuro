...
def my_plot_EavsV():
    ...
    # print(Test02)
    Energia = np.reshape(Test02, (21, 101, 12,))
    # print(Ea_V[0][0])
    # Dominio de plot:
    # for i in range(101):
    #     x = Ea_V[i, :][:, 10]
    ...
    #     plt.title('Amostra 1394 Mesa#04-Terra#01')
    ...
    plt.title('Amostra 1394 Mesa#04-Terra01 (paso voltagem = 0.1V)')
    ...
    np.savetxt('Ea1394Mesa#4_Terra01MelhorResTemAjeitada.txt',
               Ea1394, delimiter=',')
    return plt.show()
